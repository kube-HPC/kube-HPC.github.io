...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['minikube start --driver=docker   --addons ingress   --addons registry   --addons registry-aliases   --addons storage-provisioner   --kubernetes-version=v1.23.5'], ['minikube start --driver=docker \\\n  --addons ingress \\\n  --addons registry \\\n  --addons registry-aliases \\\n  --addons storage-provisioner \\\n  --kubernetes-version=v1.23.5']),
	    _templateObject2 = _taggedTemplateLiteral(['minikube start --driver=hyperv --cpus=4 --memory=6GB ^\n  --addons=ingress ^\n  --addons=registry ^\n  --addons=registry-aliases ^\n  --addons=storage-provisioner ^\n  --kubernetes-version=v1.23.5'], ['minikube start --driver=hyperv --cpus=4 --memory=6GB ^\n  --addons=ingress ^\n  --addons=registry ^\n  --addons=registry-aliases ^\n  --addons=storage-provisioner ^\n  --kubernetes-version=v1.23.5']),
	    _templateObject3 = _taggedTemplateLiteral(['minikube start --cpus=4 --memory=6GB   --addons=ingress   --addons=registry   --addons=registry-aliases   --addons=storage-provisioner   --kubernetes-version=v1.23.5'], ['minikube start --cpus=4 --memory=6GB \\\n  --addons=ingress \\\n  --addons=registry \\\n  --addons=registry-aliases \\\n  --addons=storage-provisioner \\\n  --kubernetes-version=v1.23.5']);
