...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _coreCodeTabsWithCopy = __webpack_require__(1);

	var _coreCodeTabsWithCopy2 = _interopRequireDefault(_coreCodeTabsWithCopy);

	var _corePrism = __webpack_require__(55);

	var _corePrism2 = _interopRequireDefault(_corePrism);

	var _coreSchemasInstall = __webpack_require__(56);

	var _coreSchemasInstall2 = _interopRequireDefault(_coreSchemasInstall);

	renderHere(React.createElement(_coreCodeTabsWithCopy2['default'], { schema: _coreSchemasInstall2['default'] }));
	}());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CodeTabsWithCopy = (function (_React$Component) {
	  _inherits(CodeTabsWithCopy, _React$Component);

	  function CodeTabsWithCopy(props) {
	    _classCallCheck(this, CodeTabsWithCopy);

	    _get(Object.getPrototypeOf(CodeTabsWithCopy.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      items: this._getTabs(),
	      selectedTabKey: 0,
	      copied: false
	  ...
	  _createClass(CodeTabsWithCopy, [{
	    ...
	    value: function copyCode() {
	      ...
	      var codeNode = items[selectedTabKey].getContent();

	      var textToCopy = '';

	      try {
	        if (codeNode && codeNode.props && codeNode.props.children && codeNode.props.children.props && typeof codeNode.props.children.props.children === 'string') {
	          textToCopy = codeNode.props.children.props.children;
	        } else if (codeNode && codeNode.props && typeof codeNode.props.children === 'string') {
	    ...
	    value: function render() {
	      ...
	      var selectedTabKey = _state2.selectedTabKey;
	      var copied = _state2.copied;

	      return _react2['default'].createElement(
	        'div',
	        { style: { position: 'relative' } },
	        _react2['default'].createElement(_reactResponsiveTabs2['default'], {
	          transform: false,
	          items: items,
	          showInkBar: true,
	  ...
	  return CodeTabsWithCopy;
	})(_react2['default'].Component);

	exports['default'] = CodeTabsWithCopy;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _taggedTemplateLiteral = __webpack_require__(57)['default'];

	var _String$raw = __webpack_require__(63)['default'];

	var _interopRequireDefault = __webpack_require__(31)['default'];

	var _templateObject = _taggedTemplateLiteral(['minikube start --driver=docker   --addons ingress   --addons registry   --addons registry-aliases   --addons storage-provisioner   --kubernetes-version=v1.33.4'], ['minikube start --driver=docker \\\n  --addons ingress \\\n  --addons registry \\\n  --addons registry-aliases \\\n  --addons storage-provisioner \\\n  --kubernetes-version=v1.33.4']),
	    _templateObject2 = _taggedTemplateLiteral(['minikube start --driver=hyperv --cpus=4 --memory=6GB ^\n  --addons=ingress ^\n  --addons=registry ^\n  --addons=registry-aliases ^\n  --addons=storage-provisioner ^\n  --kubernetes-version=v1.33.4'], ['minikube start --driver=hyperv --cpus=4 --memory=6GB ^\n  --addons=ingress ^\n  --addons=registry ^\n  --addons=registry-aliases ^\n  --addons=storage-provisioner ^\n  --kubernetes-version=v1.33.4']),
	    _templateObject3 = _taggedTemplateLiteral(['minikube start --cpus=4 --memory=6GB   --addons=ingress   --addons=registry   --addons=registry-aliases   --addons=storage-provisioner   --kubernetes-version=v1.33.4'], ['minikube start --cpus=4 --memory=6GB \\\n  --addons=ingress \\\n  --addons=registry \\\n  --addons=registry-aliases \\\n  --addons=storage-provisioner \\\n  --kubernetes-version=v1.33.4']);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Object$freeze = __webpack_require__(58)["default"];

	var _Object$defineProperties = __webpack_require__(61)["default"];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(14).String.raw;
